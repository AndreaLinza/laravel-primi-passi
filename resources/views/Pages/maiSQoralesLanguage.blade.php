                ...
                <div class="col-md-8 col-sm-12">
                    <div class="card card-br box-shadow">
                        <div class="position-relative">
                            ...
                            <img src={{ $maiSQorales['img'] }} class="card-img-top object-fit-cover box-shadow my-5"
                                alt="...">
                        </div>
                        <div class="card-body px-5 mb-3">
                            <h4 class="card-title fw-bold mb-4">{{ $maiSQorales['name'] }}</h4>
                            <p class="card-text"> {{ $maiSQorales['description'] }} </p>
                            <p>
                                Articolo di:
                                <a href="/Team" class="text-secondary"> {{ $maiSQorales['author'] }} </a>
                            </p>
